...
declare namespace $ {
    let $my_tsmb_folders: ((val: unknown) => Readonly<{
        name: string;
        type: string;
        remark: string;
        path: string;
        ...
        vfs: string;
        "vfs-zerocopy-write": boolean;
        "vfs-zerocopy-read": boolean;
        "files-allow": string;
        "files-deny": string;
    }>) & {
        config: {
            ...
            remark: (val: string) => string;
            path: (val: string) => string;
            ca: (val: boolean) => boolean;
            "ca-params": (val: string) => string;
            "case-insensitive": (val: boolean) => boolean;
            encrypt: (val: boolean) => boolean;
            permissions: (val: string) => string;
            "map-attributes": (val: string) => string;
            vfs: (val: string) => string;
            "vfs-zerocopy-write": (val: boolean) => boolean;
            "vfs-zerocopy-read": (val: boolean) => boolean;
            "files-allow": (val: string) => string;
            "files-deny": (val: string) => string;
        };
        Value: Readonly<{
            name: string;
            type: string;
...
declare namespace $.$$ {
    class $my_tsmb_folders_list extends $mol_object2 {
        static all(next?: Record<string, typeof $my_tsmb_folders.Value>): Record<string, Readonly<{
            name: string;
            type: string;
            remark: string;
            path: string;
...
declare namespace $ {
    class $my_tsmb_folders_list_page extends $mol_page {
        ...
        Close(): $$.$mol_link;
        items(): readonly any[];
        Items_empty(): $mol_view;
        Items(): $$.$mol_list;
        item_arg(id: any): {};
        item_id(id: any): string;
        Item_id(id: any): $mol_view;
        item_path(id: any): string;
        Item_path(id: any): $mol_view;
    }
}
...
declare namespace $.$$ {
    class $my_tsmb_folders_list_page extends $.$my_tsmb_folders_list_page {
        folders(): Record<string, Readonly<{
            name: string;
            type: string;
            remark: string;
            path: string;
        ...
        items(): $mol_link[];
        item_id(name: string): string;
        item_path(name: string): string;
...
declare namespace $ {
    class $my_tsmb_folders_page extends $mol_page {
        ...
        body(): readonly any[];
        foot(): readonly any[];
        Field(id: any): $mol_view;
        Field_text(id: any): $mol_labeler;
        Field_flag(id: any): $mol_check_box;
        ...
        field_title(id: any): string;
        field_text(id: any, val?: any): any;
        field_enabled(id: any): boolean;
        Field_text_control(id: any): $$.$mol_string;
        field_flag(id: any, val?: any): any;
    }
}
...
declare namespace $.$$ {
    class $my_tsmb_folders_page extends $.$my_tsmb_folders_page {
        title(): string;
        tools(): $mol_link[];
        folder(next?: typeof $my_tsmb_folders.Value): Readonly<{
            name: string;
            type: string;
            remark: string;
            path: string;
        ...
        keys_editable(): string[];
        fields(): ($mol_labeler | $mol_check_box)[];
        Field(id: string): $mol_labeler | $mol_check_box;
        field_title(id: string): string;
        field_enabled(id: string): boolean;
        field_text(id: string, next?: string): string;
        field_flag(id: string, next?: boolean): boolean;
        field_value(id: string): string | boolean;
        save_enabled(): boolean;
        save(): void;
    }
}
...
declare namespace $ {
    class $my_tsmb extends $mol_book2 {
        plugins(): readonly any[];
        Auth(): $$.$my_tsmb_auth_form;
        Menu(): $$.$my_tsmb_menu_page;
        Folders_list(): $$.$my_tsmb_folders_list_page;
        Folders_item(id: any): $$.$my_tsmb_folders_page;
        Danger(): $$.$my_tsmb_folders_danger_page;
...
declare namespace $.$$ {
    class $my_tsmb extends $.$my_tsmb {
        ...
        folder(): string;
        danger(): boolean;
        pages(): $my_tsmb_auth_form[] | ($my_tsmb_menu_page | $my_tsmb_folders_list_page | $my_tsmb_folders_page | $my_tsmb_folders_danger_page)[];
        logout(): void;
    }
}
...
declare namespace $ {
    ...
    function $mol_view_tree_value_type(val: $mol_tree): "locale" | "string" | "object" | "number" | "null" | "put" | "bool" | "dict" | "get" | "bind" | "list";
